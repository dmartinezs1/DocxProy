$(document).ready(function () {
    $("tr #deleteNovedades").click(function (e) {
        e.preventDefault();
        ...
        swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    ...
                    setTimeout(function () {
                        parent.location.href = "srvUsuario?accion=listarNovedadesAdmin&cod="+codEmpleado
                    }, 1800);
                } else {
    ...
    function eliminarSede(cod) {
        var url = "srvUsuario?accion=eliminarNovedades&cod=" + cod;
