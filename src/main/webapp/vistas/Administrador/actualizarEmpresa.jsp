        ...
        <section class="content">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title">Actualizar Datos Empresa</h3>
                </div>
                <form class="form-horizontal" action="srvUsuario?accion=actualizarEmpresa" method="post">
                    <input type="hidden" name="hCodigo" value="${empresa.id_empresa}">
                    <div class="box-body">
                            ...
                            <div class="col-sm-offset-2 col-sm-10">
                                <div class="checkbox">
                                    <label>
                                        ...
                                        <c:out value="${empresa.estado == false ?
                                                                       'unchecked' : 'checked'}"
                                               default=""/>>Activo
                                    </label>
                                </div>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" id="" name="btnRegistrar" value="Registrar" class="btn btn-success"><i
                                class="fa fa-refresh"></i> Actualizar Empresa
                        </button>
